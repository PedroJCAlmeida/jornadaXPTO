...
{
    public partial class registar_jogador : System.Web.UI.Page
    {
        ...
        protected void btn_registar_Click(object sender, EventArgs e)
        {
            ...
            myCommand.CommandText = "inserir_jogador";

            myCommand.Connection = myConn;
            //Passar os parametros para a SP
            myCommand.Parameters.AddWithValue("@nome_jogador", tb_jogador.Text);
            myCommand.Parameters.AddWithValue("@id_posicao", ddl_posicao.SelectedValue);
            myCommand.Parameters.AddWithValue("@id_clube", ddl_club.SelectedValue);
            myCommand.Parameters.AddWithValue("@ct_jogador", contentType);
            myCommand.Parameters.AddWithValue("@foto_jogador", imgBinaryData);
            ...
            Response.Redirect("registar_jogador.aspx");
