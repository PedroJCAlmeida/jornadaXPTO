<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gestao_clubes.aspx.cs" Inherits="jornadaXPTO.gestao_clubes" %>
            ...
            <div class="row">
                <div class="col-lg-8 left-blog-pad" >
                    <div class="schedule-text" style="width:1150px;">
                        <h4 class="st-title">Gestão de Clubes</h4>
                        <div class="st-table">
                    ...
                    <asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDataSource1" OnItemDataBound="Repeater1_ItemDataBound" OnItemCommand="Repeater1_ItemCommand" >
                        ...
                        <ItemTemplate>
                            ...
                            <tr class="text-center">
                                    ...
                                    <td><asp:Image ID="img_emblema" runat="server" Width="50px" Height="50px" /></td>
                                    <td><asp:Label ID="lbl_equipa" runat="server" Text=""></asp:Label></td>
                                    <td><asp:Label ID="lbl_cidade" runat="server" Text=""></asp:Label></td>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:jornadaXptoConnectionString %>" SelectCommand="SELECT * FROM [clubes]"></asp:SqlDataSource>
                    </div>
