<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registar_club.aspx.cs" Inherits="jornadaXPTO.registar_club" %>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="contact-form">
                        <h2>Registar Clube</h2>
                        <div class="#">
                            <div class="group-in">
                                <b>Nome:&nbsp; </b>    &nbsp;
                                <asp:TextBox ID="tb_clube" runat="server" Width="197px"></asp:TextBox>
                                <br />
                                <br />
                            </div>
                            <div class="group-in">
                                <b>Cidade:&nbsp; </b>    &nbsp;
                                <asp:TextBox ID="tb_cidade" runat="server" Width="197px"></asp:TextBox>
                                <br />
                                <br />
                            </div>
                            <div class="group-in">
                            ...
                            <asp:Button class="primary-btn" ID="btn_registar" runat="server" Text="Registar Clube" OnClick="btn_registar_Click"/>
                        </div>
                    </div>
                </div>
