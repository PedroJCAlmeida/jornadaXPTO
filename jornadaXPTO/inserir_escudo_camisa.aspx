<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="inserir_escudo_camisa.aspx.cs" Inherits="jornadaXPTO.WebForm1" %>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="contact-form">
                        <h2>Inserir Emblema e Camisola</h2>
                        <div class="#">
                            <div class="group-in">
                                <b>Nome Arquivo:&nbsp; </b>    &nbsp;
                                <asp:TextBox ID="tb_nome" runat="server" Width="197px"></asp:TextBox>
                                <br />
                                <br />
                            </div>
                            <div class="group-in">
                               <b>Selecionar Emblema:&nbsp; </b>    &nbsp;<asp:FileUpload ID="FileUpload1" runat="server" />
                                <br />
                                 <br />
                            </div>
                            <div class="group-in">
                               <b>Selecionar Camisola:&nbsp; </b>    &nbsp;<asp:FileUpload ID="FileUpload2" runat="server" />
                                <br />
                                 <br />
                            </div>
                            <asp:Button class="primary-btn" ID="btn_registar" runat="server" Text="Registar" OnClick="btn_registar_Click" />
                        </div>
                    </div>
                </div>
                 ...
                 <div class="col-lg-6">
                    <div class="contact-form">
                        <h2>Inserir Flâmula</h2>
                        <div class="#">
                            <div class="group-in">
                                <b>Nome Arquivo:&nbsp; </b>    &nbsp;
                                <asp:TextBox ID="tb_flamula" runat="server" Width="197px"></asp:TextBox>
                                <br />
                                <br />
                            </div>
                            <div class="group-in">
                               <b>Selecionar Flâmula:&nbsp; </b>    &nbsp;<asp:FileUpload ID="FileUpload3" runat="server" />
                                <br />
                                 <br />
                            </div>
                            <asp:Button class="primary-btn" ID="btn_inserir_flamula" runat="server" Text="Registar" onclick="btn_inserir_flamula_Click"/>
                        </div>
                    </div>
                </div>
            </div>
