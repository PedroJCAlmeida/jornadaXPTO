<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gestao_jogadores.aspx.cs" Inherits="jornadaXPTO.gestao_jogadores" %>
            ...
            <div class="row">
                <div class="col-lg-8 left-blog-pad" >
                    <div class="schedule-text" style="width:1150px;">
                        <h4 class="st-title">Gestão de Jogadores</h4>
                        <div class="st-table">
                    ...
                    <asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDataSource1" OnItemDataBound="Repeater1_ItemDataBound" OnItemCommand="Repeater1_ItemCommand">
                        <HeaderTemplate>
                              <table class="table">
                                    ...
                                    <td>Posição</td>
                                    <td>Ativo</td>
                                    <td><asp:Button class="btn-primary" ID="btn_salvar_todos" runat="server" Text="Salvar Todos" OnClick="btn_salvar_todos_Click"/></td>
                                </tr>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <tr class="text-center">
                                    <td><asp:Label ID="lbl_cod" runat="server" Text=""></asp:Label></td>
                                    <td><asp:Image ID="img_foto" runat="server" Width="50px" Height="50px" /></td>
                                    <td><asp:Label ID="lbl_jogador" runat="server" Text=""></asp:Label></td>
                                    <td><asp:DropDownList ID="ddl_equipa" runat="server" DataSourceID="SqlDataSource2" DataTextField="nome_clube" DataValueField="id_clube"></asp:DropDownList></td>
                                    <td><asp:DropDownList ID="ddl_posicao" runat="server" DataSourceID="SqlDataSource3" DataTextField="posicao" DataValueField="id_posicao"></asp:DropDownList></td>
                        ...
                        <asp:ListItem Value="True">Sim</asp:ListItem>
                                ...
                                <td><asp:Button class="btn-primary" ID="btn_salvar" runat="server" Text="Salvar" CommandName="btn_salvar" /></td>
                            </tr>
                        </ItemTemplate>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:jornadaXptoConnectionString %>" SelectCommand="select j.id_jogador, j.foto_jogador, j.nome_jogador, j.id_clube, j.id_posicao, j.ativado  from jogadores as j
inner join clubes as c on c.id_clube = j.id_clube
inner join posicoes as p on p.id_posicao = j.id_posicao"></asp:SqlDataSource>
                   <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:jornadaXptoConnectionString %>" SelectCommand="SELECT [id_clube], [nome_clube] FROM [clubes]"></asp:SqlDataSource>                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:jornadaXptoConnectionString %>" SelectCommand="SELECT * FROM [posicoes]"></asp:SqlDataSource>
