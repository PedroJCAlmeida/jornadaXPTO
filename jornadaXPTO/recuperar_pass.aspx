<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="recuperar_pass.aspx.cs" Inherits="jornadaXPTO.recuperar_pass" %>
                    ...
                    <div class="contact-form">
                        ...
                        <div class="">
                            ...
                            <asp:Label ID="lbl_mensagem" runat="server" Text=""></asp:Label>
                                <br />
                            <asp:Button class="primary-btn" ID="btn_recuperar" runat="server" Text="Recuperar" OnClick="btn_recuperar_Click"/>
