<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="jornadaXPTO.login" %>
                ...
                <div class="col-lg-6">
                    <div class="contact-form">
                        ...
                        <div class="">
                            ...
                            <div class="group-in">
                            Não tem conta? <asp:LinkButton ID="lbtn_cadastro" runat="server" font-size="20px" OnClick="lbtn_cadastro_Click"><b>Crie uma</b></asp:LinkButton>
                            </div>
                            <div class="group-in">
                            Esqueceu a Palavra-Passe? <asp:LinkButton ID="lbtn_recuperarPw" runat="server" font-size="20px" OnClick="lbtn_recuperarPw_Click"><b>Recuperar</b></asp:LinkButton>
                             </div>
                            <div class="group-in">
                                <br />
                                <asp:Label ForeColor="Red" Font-Bold="true" ID="lbl_mensagem" runat="server" Text=""></asp:Label>
                                <br />
                               
                            </div>
                        <br />
                            <asp:Button class="primary-btn" ID="btn_login" runat="server" Text="Login" OnClick="btn_login_Click"/>
